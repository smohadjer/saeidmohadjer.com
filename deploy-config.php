...
define('REMOTE_REPOSITORY', 'https://github.com/smohadjer/saeidmohadjer.com.git');
...
define('TMP_DIR', '/var/www/vhosts/saeidmohadjer.com/app/tmp/spgd-'.md5(REMOTE_REPOSITORY).'/');
